...
- [[#todo][TODO]]
  ...
  - [[#fix-tabs][fix tabs]]
  - [[#fix-treemacs-keybinds][fix treemacs keybinds]]
  - [[#lsp][LSP]]
...
** Mixed Pitch
Mixed pitch is a minor mode that enables mixing fixed-pitch (also known as fixed-width or monospace) and variable-pitch (AKA “proportional”) fonts.
