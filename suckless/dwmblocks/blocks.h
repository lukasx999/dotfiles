...
static const Block blocks[] = {
  ...
  {"", "~/suckless/dwmblocks/scripts/cpu_temp", 1, 0},
  {"", "~/suckless/dwmblocks/scripts/memperc", 1, 0},
  //{"Swap: ", "~/suckless/dwmblocks/scripts/swapperc", 1, 0},
  {"", "~/suckless/dwmblocks/scripts/freestorage", 1, 0},
  //{"", "~/suckless/dwmblocks/scripts/upload", 1, 0},
  //{"", "~/suckless/dwmblocks/scripts/download", 1, 0},
  {"", "~/suckless/dwmblocks/scripts/packages", 999, 0},
  ...
  {"", "~/suckless/dwmblocks/scripts/kernelinfo", 999, 0},
  {"", "~/suckless/dwmblocks/scripts/weather", 60, 0},
  {"", "~/suckless/dwmblocks/scripts/date", 999, 0},
  {"", "~/suckless/dwmblocks/scripts/time24h", 60, 0},
};
